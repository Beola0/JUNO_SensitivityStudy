...
class Reactor_Spectrum:
    ...
    def flux(self,E,th_power,plot_this=False): 
        ...
        self.tot_flux = tot_flux / tot_rate * th_power * 6.24 * 10**(21)
        ...
        if plot_this:
            ...
            ax.plot(E,self.f235u * u235/tot_rate * th_power * 6.24 * 10**(21),'b',linewidth=1.5,label=r'$^{235}$U')
            ax.plot(E,self.f239pu * pu239/tot_rate * th_power * 6.24 * 10**(21),'r',linewidth=1.5,label=r'$^{239}$Pu')
            ax.plot(E,self.f238u * u238/tot_rate * th_power * 6.24 * 10**(21),'g',linewidth=1.5,label=r'$^{238}$U')
            ax.plot(E,self.f241pu * pu241/tot_rate * th_power * 6.24 * 10**(21),'y',linewidth=1.5,label=r'$^{241}$Pu')
