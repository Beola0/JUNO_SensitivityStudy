...
ax.legend()
ax.grid()
fig.savefig('Exp_Resolution/osc_spectrum_w_resolution_num.pdf',format='pdf',transparent=True)
...
ax1.legend()
ax1.grid()
fig1.savefig('Exp_Resolution/osc_spectrum_w_resolution_np.pdf',format='pdf',transparent=True)
